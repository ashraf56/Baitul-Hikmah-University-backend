...
const createAcdemicFacultyController = (0, catchAsync_1.catchasync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicfaculty_service_1.AcademicFacultyServices.createAcdemicFacultyDB(payload);
    res.status(200).json({
        success: true,
...
const getAllAcademicFacultyController = (0, catchAsync_1.catchasync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const allfaculty = yield academicfaculty_service_1.AcademicFacultyServices.getAllAcademicFacultyFromDB();
    res.status(200).json({
        success: true,
...
const getSingleAcademicFacultyController = (0, catchAsync_1.catchasync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const singlefaculty = yield academicfaculty_service_1.AcademicFacultyServices.getSingleAcademicFacultyFromDB(id);
    res.status(200).json({
        success: true,
...
const updateAcademicFacultyController = (0, catchAsync_1.catchasync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const payload = req.body;
    const updateddata = yield academicfaculty_service_1.AcademicFacultyServices.updateAcademicFacultyIntoDB(id, payload);
    res.status(200).json({
        success: true,
