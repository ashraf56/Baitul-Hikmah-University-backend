...
const deleteAdminFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const deletedUser = yield user_model_1.default.findOneAndUpdate(userId, { isDeleted: true }, { new: true, session });
        if (!deletedUser) {
...
exports.Adminservice = {
    getAllAdminsFromDB, getSingleAdminFromDB, deleteAdminFromDB, updateAdminIntoDB
};
