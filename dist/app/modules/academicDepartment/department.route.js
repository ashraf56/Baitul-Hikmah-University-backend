...
router.get('/', department_controller_1.academicDepartmentCOntrollers.getAllAcademicDepartmentController);
router.get('/:id', department_controller_1.academicDepartmentCOntrollers.getSingleAcademicDepartmentController);
router.patch('/:id', (0, validateRequest_1.default)(department_validatin_1.academicDepartmentValidation.updateAcademicDepartmentValidationSchema), department_controller_1.academicDepartmentCOntrollers.updateAcademicDeartmentController);
